...
<span id="btns"></span><div class="component"><?php include("../components/atoms/btns.php");?></div>
<span id="form-elements"></span><div class="component"><?php include("../components/atoms/form-elements.php");?></div>